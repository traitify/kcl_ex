defmodule KinesisClient.Stream.AppState.Ecto.ShardLeases do
  ...
  @spec get_shard_lease(map, Ecto.Repo.t()) :: {:error, :not_found} | {:ok, struct()}
  ...
  @spec get_shard_lease_by_id(String.t(), Ecto.Repo.t()) :: {:error, :not_found} | {:ok, struct()}
  def get_shard_lease_by_id(shard_id, repo) do
    %{shard_id: shard_id}
    |> get_shard_lease(repo)
  end

  @spec insert_shard_lease(map, Ecto.Repo.t()) :: {:error, Ecto.Changeset.t()} | {:ok, struct()}
  ...
  @spec update_shard_lease(struct(), Ecto.Repo.t(), list) ::
          {:error, :update_unsuccessful} | {:ok, struct()}
